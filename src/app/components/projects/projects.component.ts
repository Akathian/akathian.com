...
export class ProjectsComponent implements OnInit {
  ...
  projects = [
    ...
    },
    {
      ...
      id: "st",
      link: 'https://becomestrongertogether.ca/',
      imgs: [''],
      blurb: 'Building a blogging and forum website',
      desc: [
        'In progress',
      ],
    },
    ...
    },
    {
      ...
      num: 4,
      type: 'Portfolio',
      name: 'Thayahan\'s Arts School',
      link: 'https://thayahanartsschool.ca/',
      id: "thayahan",
